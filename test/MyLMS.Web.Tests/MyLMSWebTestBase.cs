...
public abstract class MyLMSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static MyLMSWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyLMSWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<MyLMSDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<MyLMSDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<MyLMSDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<MyLMSDbContext, Task<T>> func)
    {
        T result;
